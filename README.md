...
│                         jhattasamachaar and configuration for tools like black
│
...
│
└── jhattasamachaar   <- Source code for use in this project.
    │
    ├── __init__.py             <- Makes jhattasamachaar a Python module
    │
